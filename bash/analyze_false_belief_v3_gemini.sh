#!/usr/bin/env bash
#SBATCH --job-name=fb_v3_analyze_gem
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/fb_v3_analyze_gemini_%j.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/fb_v3_analyze_gemini_%j.err
#SBATCH --partition=sphinx
#SBATCH --mem=32G
#SBATCH --cpus-per-task=2
#SBATCH --time=1:00:00

# Runs summarize + quality audit + error case extraction for the Gemini v3 results.
# Usage: sbatch bash/analyze_false_belief_v3_gemini.sh
#    or: bash bash/analyze_false_belief_v3_gemini.sh
