#!/usr/bin/env bash
#SBATCH --job-name=ll_fb_v2_gem
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/logit_lens_fb_v2_gemini_%j.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/logit_lens_fb_v2_gemini_%j.err
...
pair_dir="${REPO_ROOT}/sotopia_results_false_belief_v2_gemini/dialogs/${model_1}_None_0_${model_2}_None_0_false_belief_v2"
...
python analysis/setup_logit_lens_false_belief_v2.py \
    --model_1 "${model_1}" \
    --model_2 "${model_2}" \
    --results_dir sotopia_results_false_belief_v2_gemini \
    --output_dir logit_lens_results_false_belief_v2_gemini
