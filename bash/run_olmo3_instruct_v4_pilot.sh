#!/usr/bin/env bash
#SBATCH --job-name=olmo3_v4_fb
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo3_v4_fb_%A_%a.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo3_v4_fb_%A_%a.err
...
# Submit: sbatch bash/run_olmo3_instruct_v4_pilot.sh
