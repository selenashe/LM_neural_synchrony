#!/usr/bin/env bash
#SBATCH --job-name=sim_fb_v3
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/simulate_fb_v3_%A_%a.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/simulate_fb_v3_%A_%a.err
...
# Uses false-belief v3 stimuli.
# Submit: sbatch bash/run_simulate_false_belief_v3.sh
