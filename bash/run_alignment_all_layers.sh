#!/usr/bin/env bash
#SBATCH --job-name=align_allL
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/alignment_all_layers_%j.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/alignment_all_layers_%j.err
