#!/usr/bin/env bash
#SBATCH --job-name=fb_v3_analyze
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/fb_v3_analyze_%j.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/fb_v3_analyze_%j.err
...
# open-weight model false-belief v3 results.
# Usage: sbatch bash/analyze_false_belief_v3.sh
#    or: bash bash/analyze_false_belief_v3.sh
