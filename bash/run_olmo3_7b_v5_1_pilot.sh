#!/usr/bin/env bash
#SBATCH --job-name=olmo3_7b_v51_fb
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo3_7b_v51_%A_%a.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo3_7b_v51_%A_%a.err
...
# 4 OLMo-3 7B Instruct checkpoints x 8 v5.1 conditions = 32 array tasks.
# Sycophancy False-Belief pilot (200 trials per condition: 20 scenarios × 10 cues).
# Submit: sbatch bash/run_olmo3_7b_v5_1_pilot.sh
