#!/usr/bin/env bash
#SBATCH --job-name=olmo3_think_v4_full
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo3_think_v4_full_%A_%a.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo3_think_v4_full_%A_%a.err
...
# One array task = one OLMo-3 7B Think-track checkpoint (3 total).
# Full 100-scenario v4 3-choice forced-choice (4,800 trials per checkpoint).
# Submit: sbatch bash/run_olmo3_think_v4_3choice_full.sh
