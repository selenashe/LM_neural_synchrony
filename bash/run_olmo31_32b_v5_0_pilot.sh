#!/usr/bin/env bash
#SBATCH --job-name=olmo31_32b_v50_syco
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo31_32b_v50_%A_%a.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo31_32b_v50_%A_%a.err
...
# 4 OLMo-3.1 32B checkpoints x 8 v5.0 conditions = 32 array tasks.
...
# Submit: sbatch bash/run_olmo31_32b_v5_0_pilot.sh
