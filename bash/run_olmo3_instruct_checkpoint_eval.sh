#!/usr/bin/env bash
#SBATCH --job-name=olmo3_inst_fb
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo3_inst_fb_%A_%a.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo3_inst_fb_%A_%a.err
...
# One array task = one OLMo-3 Instruct-track checkpoint (4 total).
# Evaluates false-belief v3 scenarios with fixed Mia opening.
# Submit: sbatch bash/run_olmo3_instruct_checkpoint_eval.sh
