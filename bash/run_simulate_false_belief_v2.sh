#!/usr/bin/env bash
#SBATCH --job-name=sim_fb_v2
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/simulate_fb_v2_%A_%a.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/simulate_fb_v2_%A_%a.err
...
# Uses false-belief v2 stimuli (C1-C6 redesigned conditions).
# Submit: sbatch bash/run_false_belief_v2.sh
...
export SOTOPIA_RESULTS_DIR=sotopia_results_false_belief_v2
