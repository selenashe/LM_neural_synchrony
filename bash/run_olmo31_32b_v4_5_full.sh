#!/usr/bin/env bash
#SBATCH --job-name=olmo31_32b_v45_full
#SBATCH --account=nlp
#SBATCH --output=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo31_32b_v45_full_%A_%a.out
#SBATCH --error=/juice6/u/jshe/nlp/LM_neural_synchrony/logs/olmo31_32b_v45_full_%A_%a.err
...
python simulation/sample_olmo3_checkpoints_v4_5_factorial.py \
    ...
    --condition "${condition}" \
    --envs envs_false_belief_v4_1.json \
    --label full
