...
from analysis.affine_transformation import train_affine_transformation
from analysis.analyze_alignment import find_best_layer_pair
from experiment_config import EPISODES_NUM, MIA_AVA_RESULTS_POSTFIX, RESULTS_DIR, STAGE_A_SEEDS
from core.utils import get_short_names_and_identifiers, set_seed, split_episodes
