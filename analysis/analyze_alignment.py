...
from core.utils import REPO_ROOT, set_seed, get_all_modes, get_short_names_and_identifiers
from analysis.affine_transformation import (
...
LABELS_PATH = os.path.join(REPO_ROOT, "analysis_files", "goal_alignment_labels.json")
