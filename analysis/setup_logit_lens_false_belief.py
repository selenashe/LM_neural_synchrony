...
def main():
    parser = argparse.ArgumentParser(
        description="Phase 1: create result dirs and behavioral summaries (no GPU)."
    )
    ...
    if args.n_episodes is None:
        import json
        envs_path = os.path.join(REPO_ROOT, "sotopia_utils", "sotopia_data", "envs_false_belief.json")
