...
"""
    ...
    def to_natural_language(self, agent) -> str:
        return format_docstring(
            f"""Imagine you are {agent}, your task is to act/speak as {agent} would, keeping in mind {agent}'s social goal.
